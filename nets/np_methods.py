...
def ssd_bboxes_select_layer(predictions_layer,
                            ...
                            num_classes=8,
                            decode=True):
#bya5od lkol sora *prediction_net[i]=prediction_layerr* byb2a gwaha 2l probability of 21 classes fby5tar 2kbr probability 
...
def ssd_bboxes_select(predictions_net,
                      ...
                      num_classes=8,
                      decode=True):
    """Extract classes, scores and b8unding boxes from network output layers.
#rprediction=prediction_net
    Return:
      classes, scores, bboxes: Numpy arrays...
    """
    l_classes = []
...
def bboxes_sort(classes, scores, bboxes, top_k=400,priority_inside=True, margin=0.0):
